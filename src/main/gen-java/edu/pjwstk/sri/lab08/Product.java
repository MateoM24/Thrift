...
public class Product implements org.apache.thrift.TBase<Product, Product._Fields>, java.io.Serializable, Cloneable, Comparable<Product> {
  ...
  private static final org.apache.thrift.protocol.TField STOCK_FIELD_DESC = new org.apache.thrift.protocol.TField("stock", org.apache.thrift.protocol.TType.I64, (short)4);
  ...
  public void unsetStock() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __STOCK_ISSET_ID);
  }

  /** Returns true if field stock is set (has been assigned a value) and false otherwise */
  public boolean isSetStock() {
    return EncodingUtils.testBit(__isset_bitfield, __STOCK_ISSET_ID);
  }

  public void setStockIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __STOCK_ISSET_ID, value);
  }
